...
public class CheckHighFrequencyIntervalValidationTest  extends BaseTest {

    @InjectMocks
    private CheckTransactionHighFrequencyValidation validation;
    ...
    List<CheckTransactionValidation> validations = Lists.newArrayList(new CheckTransactionHighFrequencyValidation());
    ...
    @Test
    public void testCheckHighFrequencyIntervalValidationWithViolation() {
